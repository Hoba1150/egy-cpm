...
export default async function AccountsPage() {
  ...
  const pageDesc = settings.page_accounts_desc || "حسابات جاهزة بالسيارات والكاش وأعلى الرتب بتسليم فوري";

  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-right space-y-10">
      {/* Header Banner */}
      <div className="relative rounded-2xl bg-gradient-to-r from-purple-950/60 via-garage-900 to-indigo-950/60 border border-orange-500/30 p-6 sm:p-10  overflow-hidden">
