    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-right space-y-12">
        ...
        {carCategories.map((c, i) => {
          ...
          return (
            <Link
              key={i}
              href={`/cars/${c.slug}`}
              className="p-4 rounded-2xl bg-[#12161f] border border-gray-800 hover:border-cyan-500/50 hover: transition group flex flex-col justify-between"
            >
              <div className="flex items-center justify-between mb-3">
                <span className="text-[10px] text-gray-400 font-mono">{c.count} سيارة</span>
                <div className={`p-2 rounded-xl bg-[#1a202c] border border-gray-700 ${c.color} group-hover:scale-110 transition`}>
                  <Icon className="w-4 h-4" />
                </div>
              </div>
              <h3 className="text-xs sm:text-sm font-bold text-white group-hover:text-orange-500 transition">
                {c.title}
              </h3>
            </Link>
          );
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between border-b border-gray-800 pb-3">
          ...
          <Link href="/cars/modified" className="text-xs text-orange-500 hover:underline">
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between border-b border-gray-800 pb-3">
          ...
          <Link href="/cars/drawn" className="text-xs text-orange-400 hover:underline">
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between border-b border-gray-800 pb-3">
          ...
          <Link href="/cars/limited" className="text-xs text-red-400 hover:underline">
