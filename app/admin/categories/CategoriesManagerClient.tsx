    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {categories.map((c) => (
          <div
            key={c.id}
            className="p-5 rounded-2xl bg-garage-900 border border-gray-800 hover:border-cyan-500/40 transition flex flex-col justify-between space-y-4 group"
          >
            <div className="flex items-start gap-3.5">
              ...
              <div className="space-y-1 flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${c.isActive ? "bg-green-500/20 text-neon-green" : "bg-red-500/20 text-neon-red"}`}>
                    {c.isActive ? "نشط" : "معطل"}
                  </span>
                </div>
            ...
            <div className="flex items-center justify-between pt-3 border-t border-gray-800/80 text-[11px]">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-1.5 rounded-lg bg-garage-850 hover:bg-cyan-500/20 text-gray-300 hover:text-neon-cyan border border-gray-700 transition"
                  title="تعديل القسم"
                >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm">
          <div className="relative max-w-lg w-full bg-[#0c1017] border border-cyan-500/40 rounded-3xl p-6 shadow-glow-cyan text-right space-y-4">
            <div className="flex items-center justify-between border-b border-gray-800 pb-3">
              <h3 className="text-base font-bold text-white flex items-center gap-2">
                <FolderTree className="w-5 h-5 text-neon-cyan" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="sm:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-garage-900 border border-gray-700 rounded-xl text-xs text-white text-right dir-ltr font-mono"
                  />
                </div>
