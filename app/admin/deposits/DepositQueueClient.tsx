    ...
    <div className="space-y-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-right text-xs">
              ...
              <tbody className="divide-y divide-gray-800/60">
                {filtered.map((d) => (
                  <tr key={d.id} className="hover:bg-garage-850/50 transition">
                    <td className="p-4 font-mono font-bold text-neon-cyan">{d.requestNumber}</td>
                    <td className="p-4">
                    ...
                    <td className="p-4">
                      <div className="space-y-0.5">
                        ...
                        <span className="text-[11px] text-neon-green font-mono">{d.senderPhone}</span>
                      </div>
                    </td>
                    ...
                    <td className="p-4">
                      <span className="px-2 py-0.5 rounded bg-garage-800 text-[10px] text-gray-300 font-mono">
                        {d.method}
                      </span>
                    </td>
                    <td className="p-4">
                      <button
                        ...
                        className="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-cyan-500/10 text-neon-cyan hover:bg-cyan-500/20 transition text-xs font-bold"
                      >
                    ...
                    <td className="p-4">
                      {d.status === "APPROVED" ? (
                        <span className="px-2 py-0.5 rounded bg-green-500/20 text-neon-green text-[10px] font-bold">
                          مقبول ✅
                        </span>
                      ) : d.status === "REJECTED" ? (
                        ...
                        <span className="px-2 py-0.5 rounded bg-amber-500/20 text-neon-amber text-[10px] font-bold animate-pulse">
                          قيد المراجعة ⏳
                        </span>
                      )}
                    </td>
                      ...
                      {d.status === "PENDING" && (
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-neon-green text-black font-bold text-xs hover:shadow-glow-green transition disabled:opacity-50 flex items-center gap-1"
                          >
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-red-500/20 hover:bg-red-500/30 text-neon-red font-bold text-xs border border-red-500/30 transition disabled:opacity-50"
                          >
                            رفض
                          </button>
                        </div>
      ...
      {lightboxImage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
          <div className="relative max-w-2xl w-full bg-[#0c1017] border border-cyan-500/40 rounded-3xl p-4 shadow-glow-cyan text-right space-y-4">
            <div className="flex items-center justify-between border-b border-gray-800 pb-2">
              <span className="text-xs font-bold text-neon-cyan">معاينة إثبات التحويل (Screenshot)</span>
              <button
      ...
      {rejectModalId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="relative max-w-md w-full bg-[#0c1017] border border-red-500/40 rounded-3xl p-6 shadow-glow-red text-right space-y-4">
            ...
            <form onSubmit={handleReject} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-garage-900 border border-gray-700 rounded-xl text-xs text-white focus:border-neon-red text-right"
                />
              </div>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-garage-800 text-gray-300 text-xs font-bold hover:bg-garage-700"
                >
                  إلغاء
                </button>
              </div>
